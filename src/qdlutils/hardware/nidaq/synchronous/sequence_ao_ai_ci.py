...
class SequenceAOVoltageAIVoltageCIEdge(Sequence):
    '''
    This class implements synchronus analog voltage output (AO), analog voltage input (AI) and 
    edge counter input (CI) tasks mediated by an internal clock.
    '''
